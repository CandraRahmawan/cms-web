...
<head>
    ...
    echo $this->Html->meta(['rel' => 'canonical', 'href' => $this->Utility->buildUrl($this->Url->Build())]);
    ...
    echo $this->Html->meta(['property' => 'og:url', 'content' => $this->Utility->buildUrl($this->Url->Build())]);
